...
class LanguageService: ObservableObject {
    ...
    private let translations: [String: String] = [
        ...
        "helium_hint": "Install the Siphon Extension in Helium (chrome://extensions > Developer Mode > Load Unpacked) to automatically forward authenticated sessions and cookies.",
