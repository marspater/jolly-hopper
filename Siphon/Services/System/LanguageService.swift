...
class LanguageService: ObservableObject {
    ...
    nonisolated private static let staticTranslations: [String: String] = [
        ...
        "change_folder": "Choose Folder & Retry",
        ...
        "ytdlp_update_success_message": "Installed yt-dlp version %@.",
        "ytdlp_update_failed_title": "yt-dlp Update Failed",
        "ytdlp_update_unavailable_title": "yt-dlp Update Unavailable",
        ...
        "internal": "Provided by Uploader",
        "copied": "Copied",
        "quick_presets": "Presets",
        "single_video": "Single Video",
        "subtitle_lang_hint": "Language code, e.g. en",
        "update_ready_title": "Update Installed",
        "update_ready_message": "Restart Siphon to finish updating.",
        "language_changed_title": "Language Changed",
        "language_changed_message": "Some text updates after Siphon restarts.",
        "stop_all": "Stop All",
        ...
        "helium_extension_supported": "Chromium-based Browser Extension Ready",
        "helium_hint": "Siphon reads cookies from your active Chromium-based profile using macOS Keychain. Allow access when prompted. The Siphon Extension can also forward the current page session.",
        "chromium_extension_supported": "Chromium-based Browser Extension Ready",
        "chromium_hint": "Siphon reads cookies from your active Chromium-based profile using macOS Keychain. Allow access when prompted. The Siphon Extension can also forward the current page session.",
        ...
        "preset_best_quality_desc": "Best available codecs, highest quality",
