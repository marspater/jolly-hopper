...
class LanguageService: ObservableObject {
    ...
    private let translations: [String: String] = [
        ...
        "safari_warning": "Note: For Safari cookies, you must grant 'Full Disk Access' to Luma Pro in System Settings > Privacy & Security. Using a browser other than Safari (Chrome, Brave, etc.) will be much easier.",
        ...
        "legal_disclaimer_message": "Luma Pro is provided for personal, fair-use, and educational media downloading purposes only. Users are solely responsible for compliance with applicable copyright laws, licenses, and terms of service.",
        "ok": "OK",
